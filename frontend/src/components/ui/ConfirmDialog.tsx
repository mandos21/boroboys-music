    ...
    <Dialog.Root open={open} onOpenChange={onOpenChange}>
      <Dialog.Portal>
        ...
        <Dialog.Popup className="confirm-dialog" aria-describedby="confirm-dialog-description">
          <div className="confirm-dialog-icon" aria-hidden="true"><AlertTriangle size={21} /></div>
          <Dialog.Title>{title}</Dialog.Title>
          <Dialog.Description id="confirm-dialog-description">{description}</Dialog.Description>
          <Dialog.Close aria-label="Close confirmation" className="icon-button confirm-dialog-close">
            <X aria-hidden="true" size={18} />
          </Dialog.Close>
          <div className="confirm-dialog-actions">
            <Dialog.Close className="button button-secondary" disabled={isPending}>Cancel</Dialog.Close>
