          ...
          {user ? (
            <>
              ...
              <div className="desktop-account">
                <Link className="account-profile-link" to="/profile" aria-label="Open your profile">
              ...
              <Dialog.Root open={menuOpen} onOpenChange={setMenuOpen}>
                <Dialog.Trigger className="mobile-menu-trigger" aria-label="Open account menu">
                  <Menu aria-hidden="true" size={22} />
                </Dialog.Trigger>
                <Dialog.Portal>
                  <Dialog.Backdrop className="mobile-nav-backdrop" />
                  <Dialog.Popup className="mobile-nav-dialog" aria-label="Account menu">
                    <div className="mobile-nav-heading">
                      <span className="eyebrow">BoroCrew Music</span>
                      <Dialog.Close className="icon-button" aria-label="Close account menu">
                    ...
                    <button
                      className="button button-secondary mobile-sign-out"
                      type="button"
                      onClick={signOut}
                    >
