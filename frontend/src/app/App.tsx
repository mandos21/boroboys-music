...
function AuthErrorPage() {
  ...
  const message = { "oidc-unavailable": "The identity provider is unavailable or has not been configured yet. Try again shortly, or ask an administrator to check the sign-in setup.", denied: "The sign-in request was cancelled or denied by the identity provider. You can try again whenever you’re ready.", "expired-request": "That sign-in request has expired. Start a fresh sign-in to continue.", "invalid-request": "That sign-in link was incomplete or malformed. Start a fresh sign-in from the home page.", "verification-failed": "The identity provider’s response could not be verified. Start a fresh sign-in, or ask an administrator to check the provider configuration.", "email-verification-required": "Your identity provider needs to verify your email address before BoroCrew Music can create your account.", "provisioning-disabled": "New accounts are not being created automatically right now. Ask an administrator to enable access for you.", "account-inactive": "This account is currently inactive. Ask an administrator if you believe that is a mistake." }[reason ?? ""] ?? "The identity provider did not complete the request. Return home and try again, or check the provider configuration if this keeps happening.";
