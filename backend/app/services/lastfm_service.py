...
class LastFMService:
    ...
    def get_user_track_playcount(
        ...
        try:
            ...
            logger.warning("Failed to fetch playcount for {} - {}: {}", artist_name, track_name, exc)
            return None
    ...
    def get_track_tags(self, artist_name: str, track_name: str) -> List[str]:
        try:
            ...
            logger.debug("Failed to fetch tags for {} - {}: {}", artist_name, track_name, exc)
            return []
    ...
    def get_recent_tracks(self, username: str, limit: int = 10) -> List[Dict[str, str]]:
        try:
            ...
            logger.debug("Failed to fetch recent tracks for {}: {}", username, exc)
            return []